...
// The large offset forces CW's $at addressing macro (at = a0 + 0x50000, then
// store at a displacement from at) (assembler temp $at, recomputed per store, low part kept
...
// (v1 = 0x5 << 16) ahead of the final address computation (81.8%); the 2.3.3
