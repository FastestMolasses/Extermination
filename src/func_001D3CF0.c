...
// Area/effect command writer (mode 2). Sibling of func_001D3900/39A0/3A30:
// stages a 0x10-byte command record into the per-slot DMA/display list at
// D_00275670[a0]. First runs the func_001D3900 setup, then a fixed
// func_001D1F80(a0, 2, 2) call, writes tag 0x30, the bank base D_00816E40 +
