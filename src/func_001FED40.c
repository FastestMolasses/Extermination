...
//
// State-machine step (state 0x10). Reads the shared mode word D_00275C5C:
//   - state 0: arm this step (set state to 0x10), kick off func_00114D18(); if
//     it reports busy (nonzero) raise the busy flag D_00275C58, then return -1.
//   - state 0x10: when the result word D_00275C64 is zero, clear the state and
