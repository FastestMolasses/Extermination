// INCLUDE_ASM sub_pictureTemporalScalableExtension  (vram unknown, 12 bytes)
...
// verified with objdiff against build/expected/sub_pictureTemporalScalableExtension.o. See
