// INCLUDE_ASM sub_skiped_macroblock_in_I_picure_is  (vram unknown, 204 bytes)
...
// verified with objdiff against build/expected/sub_skiped_macroblock_in_I_picure_is.o. See
