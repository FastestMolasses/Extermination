...
// Three real input defects were fixed (98.402 -> 99.985); the last residual is the same splat symbolization artifact, and here the linked bytes are ALREADY identical. (1) func_0019B6C0 was declared with a bogus third float arg — the spurious 'mtc1 a2,$f12' shifted the whole tail by 4 and cost ~110 ...
//
