// INCLUDE_ASM sub_chroma_format_needs_to_be_1_420  (vram unknown, 356 bytes)
...
// verified with objdiff against build/expected/sub_chroma_format_needs_to_be_1_420.o. See
