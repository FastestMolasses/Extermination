...
// byte at a0[0x234], second arg always 0 (a1 cleared). 2.3.3 reproduces the
// 2.3.1 layout (a dead 0x8000 upper-half load into v0 + a hoisted upper-half load in the bnez
// delay slot) that the
// 991202 build omits.
