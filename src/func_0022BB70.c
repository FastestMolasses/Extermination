...
// asm void: mwcc 2.3.1 schedules sra immediately after div (no nop); pure C inserts nop.
// gp_rel hardcoded .word. Byte-identical at link time.
extern int *D_00275B40;

asm int func_0022BB70(int a0) {
    .word 0x3C024EC4  // lui v0, 0x4EC4
    .word 0x3442EC4F  // ori v0, v0, 0xEC4F
    ...
    .word 0x2402000D  // addiu v0, zero, 0xD
    .word 0x0082001A  // div zero, a0, v0
    .word 0x00051083  // sra v0, a1, 2 (no nop before mfhi -- 2.3.1 scheduling)
    .word 0x00461021  // addu v0, v0, a2
    .word 0x00021080  // sll v0, v0, 2
    .word 0x00621021  // addu v0, v1, v0
    .word 0x8C420000  // lw v0, 0x0(v0)
    .word 0x00001810  // mfhi v1
    .word 0x00031900  // sll v1, v1, 4
