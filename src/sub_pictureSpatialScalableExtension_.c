// INCLUDE_ASM sub_pictureSpatialScalableExtension_  (vram unknown, 12 bytes)
...
// verified with objdiff against build/expected/sub_pictureSpatialScalableExtension_.o. See
