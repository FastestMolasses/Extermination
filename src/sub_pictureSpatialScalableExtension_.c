// NEARMISS sub_pictureSpatialScalableExtension_  (vram 0x0010AD68, 0xC bytes) — readable decompilation, NOT byte-identical.
//
...
extern int D_0026B740[];
extern void func_0010A3A8(int *);

void sub_pictureSpatialScalableExtension_(void) {
    int *a0 = D_0026B740;
    func_0010A3A8(a0);
}
