// INCLUDE_ASM sub_SPECIAL_PURPOSE_MISSILE_LAUNCHER  (vram unknown, 212 bytes)
...
// verified with objdiff against build/expected/sub_SPECIAL_PURPOSE_MISSILE_LAUNCHER.o. See
