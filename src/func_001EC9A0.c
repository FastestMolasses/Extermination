// NEARMISS func_001EC9A0  (vram 0x001EC9A0, 0x7C bytes) — readable decompilation, NOT byte-identical.
//
...
// record *D_00275C34 and calls func_001CFB50(&D_0081F8F0, 0, arg0, f54, f5C, 1.0f, ~1e-6f, 30.0f), then
// fires one func_001CFBE0(arg1, 2, D_00256D30, &D_0081F8F0, 0) event on the same D_0081F8F0 object.
// 0x358637BD = 9.999999974752427e-07; 0x41F00000 = 30.0f. sq/lq frame saves $ra,$s0 (s0 = arg1 held
// across the calls). func_001CFBE0 mode = 2, trailing arg 0.
//
...
// Registers (f14=1.0,f15=1e-6,f16=30.0,t0=0) and all operand bytes identical -- only the constant-load
...
void func_001EC9A0(int arg0, int arg1) {
    func_001CFB50(D_0081F8F0, 0, arg0,
                  *(float *)((char *)D_00275C34 + 0x54),
                  *(float *)((char *)D_00275C34 + 0x5C),
                  1.0f, 9.999999974752427e-07f, 30.0f);
    func_001CFBE0(arg1, 2, D_00256D30, D_0081F8F0, 0);
}
