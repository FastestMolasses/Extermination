...
//   +0x00  low  32 bits of the 64-bit value a2 (zero-extended via a 64-bit shift pair)
//   +0x04  high 32 bits of a2, sign-extended (a 64-bit logical right shift grabs the high half,
//          then a 64-bit shift-left/arithmetic-right pair sign-extends the stored int)
...
// the word store to *a0 and drops the 64-bit shift-pair materialization CW emits (63.6%).
