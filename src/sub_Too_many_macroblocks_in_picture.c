// INCLUDE_ASM sub_Too_many_macroblocks_in_picture  (vram unknown, 512 bytes)
...
// verified with objdiff against build/expected/sub_Too_many_macroblocks_in_picture.o. See
