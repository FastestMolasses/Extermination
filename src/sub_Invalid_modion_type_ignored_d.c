// INCLUDE_ASM sub_Invalid_modion_type_ignored_d  (vram unknown, 820 bytes)
...
// verified with objdiff against build/expected/sub_Invalid_modion_type_ignored_d.o. See
