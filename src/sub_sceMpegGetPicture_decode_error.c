// INCLUDE_ASM sub_sceMpegGetPicture_decode_error  (vram unknown, 728 bytes)
...
// verified with objdiff against build/expected/sub_sceMpegGetPicture_decode_error.o. See
