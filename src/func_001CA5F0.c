// NEARMISS func_001CA5F0  (vram 0x001CA5F0, 0xEC bytes) — readable decompilation, NOT byte-identical.
//
...
// jr-table external-dispatch wall (proven s84) — ONLY residual (local @15 vs external jtbl_0026E310 on the dispatch lw). Instruction stream otherwise identical. Two levers were required: (a) the store must be written INSIDE each case, not hoisted to a common tail — the tail form drops to 46.7% beca...
//
