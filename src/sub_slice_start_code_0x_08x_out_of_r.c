// INCLUDE_ASM sub_slice_start_code_0x_08x_out_of_r  (vram unknown, 292 bytes)
...
// verified with objdiff against build/expected/sub_slice_start_code_0x_08x_out_of_r.o. See
