...
//
// objdiff 99.88% via mwcc 2.3.3 (mwcps2-2.3.3-000906) (-O4,p -sdatathreshold 0). Object similarity does not prove semantic equivalence.
// Remaining differences in this candidate:
// Only residual: the expected object renders scratchpad 0x70003B74,0x70003B76,0x70003B78,0x70003B7C,0x70003B7E as literal operands (not in build.py _SPAD_SYMS) while this C uses relocated externs; linked bytes identical. objdiff 100.0% with _SPAD_SYMS += 0x70003B74,0x70003B76,0x70003B78,0x70003B7C,...
//
...
//
// MATCH NOTE (m1-firstlevel-matching lane): the scratchpad globals at 0x70003B74, 0x70003B76, 0x70003B78, 0x70003B7C, 0x70003B7E
...
// Reads pad bits from EE scratchpad words 0x70003B74..0x70003B7E masked by
...
extern unsigned short D_70003B76;
...
int func_001607D0(char *p) {
    ...
    *(float *)(p + 0x1FC) = 1.0f;
    ...
    case 0x00:
        ...
        if (D_00810E74 & D_70003B78) {
            *(char *)(p + 5) = 0x21;
            *(char *)(p + 6) = 0;
            *(unsigned char *)(p + 0x1F0) = 0x36;
            return 1;
        }
        if (D_00810E74 & D_70003B74) {
            *(char *)(p + 5) = 0x22;
            *(char *)(p + 6) = 0;
    ...
    case 0x31:
        ...
        if (D_00810E70 & D_70003B74) {
            return func_0017A970(p, 1);
        }
        if (D_00810E74 & D_70003B76) {
