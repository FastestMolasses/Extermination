// NEARMISS gs_readback_queue_run  (vram 0x001AAE40, ?) — readable decompilation, NOT byte-identical.
//
...
// symbol_addrs.txt needs gs_readback_queue_run size:0x300 plus a real function
...
void gs_readback_queue_run(void) {
    char *p;
    char *q;
    short flip;
    short vsync;
