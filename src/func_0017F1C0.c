...
// asm void: scheduler places paddub a0,s0,zero before jal func_0019AD00 (pure C);
// 2.3.1 puts it in the delay slot. All lui/addiu %hi/%lo hardcoded. Byte-identical at link time.
extern void func_001026A0(int, int, int);
extern void func_0019AD00(int, int, int);
extern int D_700038A0;
extern int D_700038B0;

asm void func_0017F1C0(int a0) {
    ...
    .word 0x3C024120  // lui v0, 0x4120
    .word 0x3C017000  // lui at, 0x7000
    .word 0xAC2238A4  // sw v0, 0x38A4(at)
    .word 0x3C0240A0  // lui v0, 0x40A0
    .word 0x3C017000  // lui at, 0x7000
