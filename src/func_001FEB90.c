...
//
// Async-stream state-machine step (state 6), sibling of func_001FEC20/FEA70/FEB00.
// Reads the shared mode word D_00275C5C:
//   - state 0: arm this step (set state to 6), kick off func_00114708(); if it
//     reports busy (nonzero) raise the busy flag D_00275C58, then return -1.
//   - state 6: when the result word D_00275C64 is non-negative, clear the state
