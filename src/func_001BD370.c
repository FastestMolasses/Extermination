...
s32 func_001BD370(struct S *arg0) {
    float k = 0.2f;
    float temp_f1;
    float temp_f1_2;
    temp_f1 = arg0->f10 + k;
    arg0->f10 = temp_f1;
    if (!(temp_f1 < 3.0f)) {
        if (!(temp_f1 < 5.0f)) { arg0->f10 = 5.0f; }
        temp_f1_2 = arg0->f14 + k;
        arg0->f14 = temp_f1_2;
        if (!(temp_f1_2 <= 5.0f)) { arg0->f14 = 5.0f; return 1; }
        goto block_5;
    }
block_5:
    M2C_FIELD(M2C_FIELD(D_00275B40, s8 **, 4), f32 *, 0x7C) = (f32) -arg0->f14;
    M2C_FIELD(M2C_FIELD(D_00275B40, s8 **, 8), f32 *, 0x7C) = (f32) (-arg0->f10 - arg0->f14);
    M2C_FIELD(M2C_FIELD(D_00275B40, s8 **, 0xC), f32 *, 0x7C) = (f32) (arg0->f10 + arg0->f14);
    M2C_FIELD(M2C_FIELD(D_00275B40, s8 **, 0x10), f32 *, 0x7C) = (f32) arg0->f14;
    return 0;
}
