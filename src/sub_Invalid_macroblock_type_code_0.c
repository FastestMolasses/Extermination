// INCLUDE_ASM sub_Invalid_macroblock_type_code_0  (vram unknown, 1316 bytes)
...
// verified with objdiff against build/expected/sub_Invalid_macroblock_type_code_0.o. See
