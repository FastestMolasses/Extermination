...
//
// objdiff 86.58% via mwcc 2.3.3 (mwcps2-2.3.3-000906) (-O4,p -sdatathreshold 0). The LOGIC and STRUCTURE are faithful; the residual
// diff is a genuine compiler artifact that no source change fixes here:
// Register-allocation-ORDER wall (residual, not clean-store nop). Body/control-flow/addressing are byte-identical (frame 0xb0 matches, s0/s1/s2/s5/s6 all colored correctly across the whole function). The ONLY residual is two locals that individually need a saved register across the whole function -...
//
