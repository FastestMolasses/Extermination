// NEARMISS func_001EBBB0  (vram 0x001EBBB0, 0x7C bytes) — readable decompilation, NOT byte-identical.
//
...
// Identical wall to func_001EACF0 (same template, const 3.0f, table D_002561F0, flag 1): FP-constant scheduling permutation - target hoists the 1e-6f const before paddub s0,a1, mwcc emits 1.0f first. Body 100% correct. Scheduling/FP-coloring permutation -> permuter.
//
...
// func_001CFBE0(arg1, 1, D_002561F0, &D_0081F8F0, 0). sq/lq frame saves $ra,$s0
