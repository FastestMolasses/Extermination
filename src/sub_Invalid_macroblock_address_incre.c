// INCLUDE_ASM sub_Invalid_macroblock_address_incre  (vram unknown, 272 bytes)
...
// verified with objdiff against build/expected/sub_Invalid_macroblock_address_incre.o. See
