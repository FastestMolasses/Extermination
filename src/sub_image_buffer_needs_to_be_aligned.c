// INCLUDE_ASM sub_image_buffer_needs_to_be_aligned  (vram unknown, 368 bytes)
...
// verified with objdiff against build/expected/sub_image_buffer_needs_to_be_aligned.o. See
