// INCLUDE_ASM sub_sequenceScalableExtension_is_not  (vram unknown, 12 bytes)
...
// verified with objdiff against build/expected/sub_sequenceScalableExtension_is_not.o. See
