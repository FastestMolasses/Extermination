...
extern void func_00102B38(int, int, int, int);

asm void func_00102B08(void) {
    mtc1       $zero, $f0
    c.lt.s     $f12, $f0
    ...
    .word 0x4b002983  /* was: vaddw.x    $vf6, $vf5, $vf0w */
    .word 0x4a202a43  /* was: vaddw.w    $vf9, $vf5, $vf0w */
    .word 0x4a64212c  /* was: vsub.zw    $vf4, $vf4, $vf4 */
    .word 0x4a4429c0  /* was: vaddx.z    $vf7, $vf5, $vf4x */
    .word 0x4a8429c1  /* was: vaddy.y    $vf7, $vf5, $vf4y */
    .word 0x4a842a04  /* was: vsubx.y    $vf8, $vf5, $vf4x */
