// INCLUDE_ASM sub_load_chroma_non_intra_quantizer_  (vram unknown, 172 bytes)
...
// verified with objdiff against build/expected/sub_load_chroma_non_intra_quantizer_.o. See
